...
const mapStyle: StyleSpecification = {
	...
	layers: [
		...
		},
		{
			...
			source: 'openmaptiles',
			'source-layer': 'transportation',
			filter: ['all', ['==', '$type', 'LineString'], ['in', 'class', 'proposedCycleway']],
			layout: { 'line-cap': 'round', 'line-join': 'round' },
			paint: {
		...
		},
		{
			...
			source: 'openmaptiles',
			'source-layer': 'transportation',
			filter: ['all', ['==', '$type', 'LineString'], ['in', 'class', 'constructionCycleway']],
			layout: { 'line-cap': 'round', 'line-join': 'round' },
			paint: {
		...
		},
		{
			...
			source: 'openmaptiles',
			'source-layer': 'transportation',
			filter: ['all', ['==', '$type', 'LineString'], ['in', 'class', 'safeSpeed']],
			layout: { 'line-cap': 'round', 'line-join': 'round' },
			paint: {
		...
		},
		{
			...
			source: 'openmaptiles',
			'source-layer': 'transportation',
			filter: ['all', ['==', '$type', 'LineString'], ['in', 'class', 'sharedPath']],
			layout: { 'line-cap': 'round', 'line-join': 'round' },
			paint: {
		...
		},
		{
			...
			source: 'openmaptiles',
			'source-layer': 'transportation',
			filter: ['all', ['==', '$type', 'LineString'], ['in', 'class', 'separatedCycleway']],
			layout: { 'line-cap': 'round', 'line-join': 'round' },
			paint: {
		...
		},
		{
			...
			filter: [
				'all',
				['==', '$type', 'Point'],
				['!in', 'class', 'suburb', 'town', 'city', 'state', 'country', 'continent']
			],
			layout: {
				'text-anchor': 'center',
				'text-field': '{name:latin}\n{name:nonlatin}',
